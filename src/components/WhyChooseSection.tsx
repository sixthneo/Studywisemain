        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full mb-4 text-3xl" style={{ backgroundColor: '#FFF500' }}>
                  {feature.emoji}
                </div>
                <h3 className="mb-3" style={{ color: '#35979C' }}>
                  {feature.title}
                </h3>
